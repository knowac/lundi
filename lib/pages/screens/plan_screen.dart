            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  LundiSlider(
                    label: S.of(context).planFormInterestsNature,
                  ),
                  LundiSlider(
                    label: S.of(context).planFormInterestsCulture,
                  ),
                  LundiSlider(
                    label: S.of(context).planFormInterestsCities,
                  ),
                  LundiSlider(
                    label: S.of(context).planFormInterestsFood,
                  ),
                  ElevatedButton(
                    onPressed: () {
